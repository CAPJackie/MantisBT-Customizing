...
$g_reminder_receive_threshold = TEST_CONSULTANT;
...
$g_view_attachments_threshold = TEST_CONSULTANT;
$g_download_attachments_threshold = TEST_CONSULTANT;
$g_delete_attachments_threshold = TEST_CONSULTANT;
$g_allow_delete_own_attachments = ON;
$g_report_bug_threshold = TEST_CONSULTANT;
$g_update_bug_threshold = TEST_CONSULTANT;
$g_view_bug_threshold = TEST_CONSULTANT;
$g_monitor_bug_threshold = TEST_ENGINEER;
$g_monitor_add_others_bug_threshold = TEST_CONSULTANT;
$g_monitor_delete_others_bug_threshold = TEST_TEAM_LEADER;
$g_private_bug_threshold = TEST_TEAM_LEADER;
$g_handle_bug_threshold = TEST_CONSULTANT;
$g_private_bugnote_threshold = TEST_TEAM_LEADER;
$g_view_handler_threshold = TEST_CONSULTANT;
$g_view_history_threshold = TEST_CONSULTANT;
$g_bug_reminder_threshold = TEST_CONSULTANT;
...
$g_view_proj_doc_threshold = TEST_CONSULTANT;
...
$g_create_project_threshold = TEST_MANAGER;
...
$g_show_monitor_list_threshold = TEST_ENGINEER;
...
$g_view_changelog_threshold = TEST_CONSULTANT;
$g_timeline_view_threshold = TEST_CONSULTANT;
$g_roadmap_view_threshold = TEST_CONSULTANT;
$g_roadmap_update_threshold = TEST_CONSULTANT;
$g_update_bug_status_threshold = TEST_CONSULTANT;
$g_reopen_bug_threshold = TEST_CONSULTANT;
$g_report_issues_for_unreleased_versions_threshold = TEST_CONSULTANT;
$g_set_bug_sticky_threshold = TEST_TEAM_LEADER;
$g_development_team_threshold = TEST_ENGINEER;
$g_set_status_threshold = array( NEW_ => TEST_CONSULTANT );
$g_manage_configuration_threshold = TEST_TEAM_LEADER;
$g_view_configuration_threshold = TEST_ENVIRONMENT_ENGINEER;
$g_set_configuration_threshold = TEST_ENVIRONMENT_ENGINEER;
$g_create_permalink_threshold = TEST_ENGINEER;

$g_access_levels_enum_string = '40:test consultant,50:test engineer,55:test team leader,70:test manager,90:test environment engineer';


$g_manage_custom_fields_threshold = TEST_TEAM_LEADER;
$g_custom_field_link_threshold = TEST_TEAM_LEADER;

$g_tag_view_threshold = TEST_CONSULTANT;
$g_tag_attach_threshold = TEST_CONSULTANT;
$g_tag_detach_threshold = TEST_ENGINEER;
$g_tag_detach_own_threshold = TEST_ENGINEER;
...
$g_due_date_update_threshold = TEST_CONSULTANT;
$g_due_date_view_threshold = TEST_CONSULTANT;
$g_show_log_threshold = TEST_TEAM_LEADER;

$g_webservice_readonly_access_level_threshold = TEST_CONSULTANT;
$g_webservice_readwrite_access_level_threshold = TEST_CONSULTANT;
$g_webservice_admin_access_level_threshold = TEST_TEAM_LEADER;
$g_webservice_specify_reporter_on_add_access_level_threshold = TEST_ENGINEER;
